...
def recategorize(x):
 ...
 # المحافظة معلومة جغرافية مستقلة، وليست تصنيفاً تحريرياً. وجود بغداد/كركوك في خبر عربي أو دولي لا يجعله خبراً محلياً.
 x['governorate']=g;x['kirkuk']=g=='كركوك'
 ...
 x['region']='عربي ودولي' if x['category']=='عربي ودولي' else (g if g else 'العراق')
def score(x):
