...
.wrap{width:min(1380px,calc(100% - 30px))}.header{box-shadow:0 2px 12px rgba(0,0,0,.04);position:relative;z-index:5}.head{min-height:104px}.brand img{filter:drop-shadow(0 3px 7px rgba(0,0,0,.08))}.nav{box-shadow:0 3px 10px rgba(0,0,0,.08);position:sticky;top:0;z-index:20}.nav a{transition:.18s}.ticker{position:relative;z-index:19;box-shadow:0 2px 9px rgba(0,0,0,.05)}
...
@media(max-width:1050px){.lead{height:430px}.grid{gap:12px}}@media(max-width:700px){.wrap{width:calc(100% - 12px)}.nav{position:relative}.ticker{height:43px}.lead{height:335px;border-radius:11px}.lead h1{font-size:20px}.latest{border-radius:11px}.section{margin-top:22px}.headSec h2{font-size:17px}.grid{gap:8px}.thumb{height:135px}.body h3{font-size:10px}.card{border-radius:9px}.feature{height:205px}.cat{border-radius:9px}}
</style>
...
print('UI POLISH: official logo watermark applied to news image containers')
